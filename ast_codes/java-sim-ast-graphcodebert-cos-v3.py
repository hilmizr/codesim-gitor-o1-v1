...
def get_graphcodebert_embedding(code_string):
    """
    Generates a GraphCodeBERT embedding for the given code string using mean pooling across all token embeddings.
...
def visualize_embeddings(embeddings, labels):
    ...
    plt.legend()
    plt.title("PCA of GraphCodeBERT Embeddings")
...
def main():
    ...
    # embeddings/AST/GraphCodeBERT/{datetime}/
