...
def get_codebert_embedding(code_string):  # Updated function name
    """
    Generates a CodeBERT embedding for the given code string.
...
def main():
    ...
    # embeddings/AST/CodeBERT/{datetime}/  # Updated path to reflect CodeBERT
