...
import numpy as np
import javalang  # Library to parse Java code into ASTs
...
def get_embedding(file_path, embedding_base_path, relative_path, ast_base_path, ast_relative_path):
    """
...
def main():
    ...
    # Define the base path for embeddings and ASTs
    embedding_base_path = os.path.join(os.getcwd(), "embeddings")
    ast_base_path = os.path.join(os.getcwd(), "asts")
